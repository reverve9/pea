...
('a0000000-0000-4000-8000-000000000003','박도윤','male','01011110003','ski_adv','{"apparel":true,"apparel_size":"XL","goggle":true,"protector":true,"protector_size":"L","glove":true,"glove_size":"L"}'::jsonb,'920303',NULL,true,0,388000),
('a0000000-0000-4000-8000-000000000004','최지우','female','01011110004','board_beginner','{"apparel":false,"apparel_size":null,"goggle":true,"protector":false,"glove":true,"glove_size":"M"}'::jsonb,'910404','v1:0d159306eb394be37633a7cf:835567882dee8b9950f1bb9756168a04:539a5d4dff9452',true,0,338000),
...
-- ══════════════════════════════════════════════════════════════════════════════
-- price_breakdown.meta.rental_qty = 신청 시 구매한 렌탈 수량(대표 배정 정합성·매트릭스 카운터 원천).
...
-- (2) 3인 — 렌탈 의류2·고글1 구매하나 아직 미배정(대표 배정 시작 상태). 동반 2명 미입력.
('b0000000-0000-4000-8000-000000000002','SFP-27-00002',(SELECT id FROM sessions WHERE label='주중2박 2차수' LIMIT 1),'01022220002','윤서아',NULL,3,892500,'{"kind":"jayul","meta":{"rental_qty":{"apparel":2,"goggle":1,"protector":0,"glove":0}}}'::jsonb,'pending',NULL,'가족 동반 · 같은 방 배정 희망',NULL,ARRAY['체육교육회 홈페이지'],true,now(),true,now()-interval '3 hours','윤서아',now()-interval '5 hours'),
-- (3) 3인 — 의류2·보호대1·장갑1 완전 배정(대표+동반1). 동반1 사이즈까지 완료, 동반2 미입력. 상태 paid.
...
-- (4) 5인 — 의류3·보호대2·고글1·장갑1 전원 배정+사이즈 완료. 보험 혼재(복호 3건). 입금신고 불일치.
('b0000000-0000-4000-8000-000000000004','SFP-27-00004',(SELECT id FROM sessions WHERE label='주말1박 1차수' LIMIT 1),'01022220004','한지훈','한지훈모',5,1045000,'{"kind":"jayul","meta":{"rental_qty":{"apparel":3,"goggle":1,"protector":2,"glove":1}}}'::jsonb,'pending',NULL,'가족 5인 · 리프트권 인원 확인 요망',NULL,ARRAY['학교 내 공문'],true,now(),false,now()-interval '30 minutes','한지훈',now()-interval '3 hours'),
-- (5) 4인 — 의류1 구매·미배정. 완료(completed) 상태인데 동반 미입력(엣지).
...
INSERT INTO participants (application_id, name, gender, phone, lesson_level, rentals, birth_front, birth_back_enc, is_leader, sort_order, line_amount) VALUES
-- SFP-00001 (1인): 렌탈 없음
('b0000000-0000-4000-8000-000000000001','강태호','male','01022220001','jayul_freeride','{"insurance_wanted":false,"equipment":null,"apparel":false,"protector":false,"goggle":false,"glove":false}'::jsonb,'950601',NULL,true,0,437500),
-- SFP-00002 (3인): 렌탈 미배정(대표가 지금 배정). 대표 보험희망·용품세트만.
...
-- SFP-00003 (3인): 완전 배정(의류2·보호대1·장갑1). 대표=의류+장갑(사이즈 미입력), 동반1=의류+보호대+보험(사이즈 완료), 동반2 미입력.
...
('b0000000-0000-4000-8000-000000000003','임하람','female','01022220013','jayul_board','{"insurance_wanted":true,"equipment":"board","apparel":true,"apparel_size":"M","protector":true,"protector_size":"L","goggle":false,"glove":false}'::jsonb,'930615','v1:e923cd94c40e469a1e888f8d:cd387d75aaaf68999e5a84cdc2b88141:c9b302d6ac27d8',false,1,0),
('b0000000-0000-4000-8000-000000000003','참가자 3',NULL,NULL,NULL,'{}'::jsonb,NULL,NULL,false,2,0),
-- SFP-00004 (5인): 전원 배정+사이즈 완료. 의류3(지훈·서준·도경)·보호대2(서준·도경)·고글1(지훈)·장갑1(지아). 보험 3건(지훈·서준·도경).
('b0000000-0000-4000-8000-000000000004','한지훈','male','01022220004','jayul_ski','{"insurance_wanted":true,"equipment":"ski","apparel":true,"apparel_size":"L","protector":false,"goggle":true,"glove":false}'::jsonb,'890905','v1:79ba712178b80130a08a3b39:821917e5406acb1e4245bca2279ab086:0c53d8a5e362a5',true,0,1045000),
('b0000000-0000-4000-8000-000000000004','한서준','male','01022220014','jayul_ski','{"insurance_wanted":true,"equipment":"ski","apparel":true,"apparel_size":"M","protector":true,"protector_size":"M","goggle":false,"glove":false}'::jsonb,'110228','v1:04e757ae5eae6407d2550c77:238a00d0bcc08952d379258c3c0e950d:2903503b1010bf',false,1,0),
...
('b0000000-0000-4000-8000-000000000004','한도경','female','01022220034','jayul_board','{"insurance_wanted":true,"equipment":"board","apparel":true,"apparel_size":"L","protector":true,"protector_size":"L","goggle":false,"glove":false}'::jsonb,'120810','v1:e3d4a84dafe534e1d76e90d3:3aa62e36f8811f7302710e053b672d8d:e28228611d27e8',false,3,0),
...
-- SFP-00005 (4인): 의류1 미배정. 대표 보험희망·용품세트만. 동반3 미입력.
