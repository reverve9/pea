...
function LoginForm() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#f7f8f9] px-4">
      <div className="w-full max-w-[360px] rounded-[16px] border border-[#eceef1] bg-white px-8 py-9 shadow-[0_1px_2px_rgba(0,0,0,0.04)]">
        {/* 로고 */}
        ...
        <form onSubmit={submit} className="space-y-3">
          <input
            ...
            autoFocus
            className="w-full rounded-[10px] border border-[#e2e5e9] bg-white px-3.5 py-2.5 text-[14px] text-[#1f2937] outline-none transition-colors placeholder:text-[#b0b6be] focus:border-[#1e3a5f]"
          />
          <input
            type="password"
            value={password}
