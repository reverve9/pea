...
interface AppShellProps {
  ...
  main: ReactNode
  // 확장 페인(데스크탑 ≥768 우측 880px 전용, 콘텐츠 720 + 좌우 pad 80). 모바일에서는 숨김.
  extended?: ReactNode
}

// 나인브릿지 MainLayout 을 App Router 라우트 기반으로 적응:
// 3컬럼 [좌 gutter | 1380 중앙(500+880) | 우 gutter], 와이드 gutter 음영 그대로.
  ...
  return (
    <div className="h-screen bg-[#ffffff] overflow-hidden">
      <div className="flex h-screen">
        ...
        {/* 가운데 고정 영역 (1380px = 500 + 880) */}
        <div className="flex w-full min-[500px]:w-[500px] md:w-[1380px] flex-shrink-0 mx-auto md:mx-0">
          ...
          {/* 확장 페인 (≥768 전용, 880px 고정 = 콘텐츠 720 + pl/pr 80) */}
          <div className="hidden md:block w-[880px] flex-shrink-0 h-screen overflow-y-auto custom-scrollbar">
            <div className="pl-[80px] pr-[80px] pt-[25px] pb-[50px] [container-type:inline-size]">{extended}</div>
          </div>
        </div>
